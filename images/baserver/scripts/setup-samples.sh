...
if [ ! -f $PENTAHO_HOME/.samples_touched ]; then
  ...
  perl -0777 -i -pe 's/$/template_my_green_template=BioMe Template/' $PENTAHO_HOME/server/biserver-ee/pentaho-solutions/system/importExport.xml
